                    ...
                    <div className='col-12'>
                        ...
                        <div className="social-menu pt-3">
                            <ul>
                                ...
                                {/* <li><a href="https://www.linkedin.com/in/muzammil-ramzan-7060a0213" target="blank"><i className="fab fa-linkedin-in"></i></a></li> */}
                        ...
                        <div id="footer-grid">
                            <div id="left-footer-section" className="footer-section">
                                <div className="footer-information text-white text-start">
                                    ...
                                    <p className='footer-p'><MdCall style={{ color: "white" }} size={30} />&nbsp;&nbsp;+92 334 7768576</p>
                                    <p className='footer-p'><MdEmail style={{ color: "white" }} size={30} />&nbsp;&nbsp;ahsanshary208@gmail.com</p>
